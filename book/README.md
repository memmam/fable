...
A guided tour of the Fable programming language, organized by topic. Every
...
11. [The Toolchain](11-toolchain.md) — `fable test`, the formatter, the
    `fable lsp` language server, and the disassembler.
12. [Idioms and Style](12-idioms.md) — writing Fable well: the fast, clear,
